...
def compute_regression(results):
    # Constants representing the component weights
    components_weights = [
        (-0.0001, "total_line_length"),
        (-0.0021, "max_line_length"),
        (0.0076, "total_identifiers"),
        (-0.0004, "total_identifier_length"),
        (-0.0067, "max_identifier_length"),
        (-0.005, "avg_identifier_length"),
        (0.0225, "avg_arithmetic_operations"),
        (0.9886, "avg_branches"),
        (0.1572, "avg_loops"),
        (0.0119, "total_assertions"),
        (-0.0147, "total_has_assertions"),
        (0.1242, "avg_characters"),
        (-0.043, "total_class_instances"),
        (-0.0127, "total_distinct_methods"),
        (0.0026, "avg_str_length"),
        (0.1206, "total_has_exceptions"),
        (-0.019, "total_unique_identifiers"),
        (-0.0712, "max_nulls"),
        (-0.0078, "total_numbers"),
        (0.1444, "avg_nulls"),
        (0.334, "total_identifier_ratio"),
        (0.0406, "total_method_ratio"),
        (-0.0174, "total_floats"),
        (-0.3917, "total_byte_entropy"),
    ]

    # Base score
    test_score = 5.7501

    # Calculate the test score using the weights and results
    for weight, component_name in components_weights:
        test_score += weight * results[component_name]
